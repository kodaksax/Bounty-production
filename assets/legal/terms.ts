...
We are Bounty finder, doing business as Bounty ("Company," "we," "us," "our"), a company registered in California, United States at 25552 Adriana st, Mission Viejo, CA 92691.

We operate the mobile application Bounty Finder (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").

BOUNTY makes it fast and safe to post small jobs ("bounties"), get matched with a hunter, coordinate in-app, and settle payment via an escrow flow. Designed for trust, speed, and clarity.

You can contact us by phone at (+1)1-949-370-0909, email at Support@bountyfinder.app, or by mail to 25552 Adriana st, Mission Viejo, CA 92691, United States.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Bounty finder, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: Support@bountyfinder.app. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
