...
//
// Note: With Expo SDK 54+ and expo-router v6+ (currently using ^6.0.21), expo-router/entry
// handles HMR setup internally via @expo/metro-runtime. The previous polyfills that attempted
// to load HMRClient manually are no longer needed and were causing errors including:
