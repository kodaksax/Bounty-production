    ...
    <AnimatedScreen animationType="fade" duration={300}>
      ...
      >
        <View
          ...
          style={{ backgroundColor: theme.background, paddingTop: insets.top + 24, paddingBottom: insets.bottom + 24 }}
        >
          ...
          <View className="items-center mb-8">
            ...
            <Text className="text-center mt-2 text-sm leading-5" style={{ color: theme.text }}>
          ...
          {/* Code input */}
          <View className="mb-4">
            <Text className="text-sm mb-2" style={{ color: theme.text }}>Verification Code</Text>
            <TextInput
              ref={inputRef}
              value={code}
              onChangeText={text => {
          ...
          {/* Help text */}
          <Text className="text-xs text-center mt-6 leading-4" style={{ color: theme.textSecondary }}>
