    ...
    <View className="flex-1 bg-[#0B0F14]">
      ...
      >
        ...
        <View className="mb-6">
          ...
          {/* Upload Button */}
          <TouchableOpacity
            className="bg-[#1F2937] border-2 border-dashed border-[#374151] rounded-lg py-6 flex items-center justify-center mb-3"
          ...
          >
            {isUploading ? (
              <>
                ...
                <Text className="text-[#9CA3AF] mt-2 text-sm">
              ...
              <>
                <MaterialIcons name="cloud-upload" size={32} color="#6ee7b7" />
                <Text className="text-[#9CA3AF] mt-2 text-sm">
