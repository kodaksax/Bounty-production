...
function BountyGridItemComponent({
  ...
  const handlePressIn = useCallback(() => {
    Animated.spring(scaleAnim, { toValue: 1.04, useNativeDriver: true, speed: 24, bounciness: 5 }).start()
  }, [scaleAnim])
...
export const BountyGridItem = React.memo(BountyGridItemComponent, (prev, next) =>
  prev.id === next.id &&
