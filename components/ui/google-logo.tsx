...
/**
 * Official multi-color Google "G" logomark, rendered as vector paths so it
 * always shows the real brand colors regardless of theme (unlike a
 * single-color icon-font glyph).
 */
