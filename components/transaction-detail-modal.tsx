...
const styles = StyleSheet.create({
  ...
  summaryIcon: { height: 48, width: 48, borderRadius: 24, backgroundColor: 'rgba(20,40,32,0.65)', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  summaryTitle: { color: '#fff', fontSize: 16, fontWeight: '600', marginBottom: 4 },
  summaryMeta: { color: '#d1fae5', fontSize: 13 },
  amountPill: { backgroundColor: 'rgba(20,40,32,0.75)', borderRadius: 16, paddingVertical: 14, paddingHorizontal: 18, marginBottom: 14 },
  ...
  detailIcon: { height: 32, width: 32, borderRadius: 16, backgroundColor: 'rgba(20,40,32,0.7)', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  detailContent: { flex: 1 },
  detailLabel: { color: '#6ee7b7', fontSize: 11, marginBottom: 2 },
  detailValue: { color: '#fff', fontSize: 14, fontWeight: '500' },
  escrowBlock: { marginHorizontal: 24, marginTop: 12, marginBottom: 8, backgroundColor: 'rgba(20,40,32,0.7)', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#047857' },
