      ...
      >
        <TouchableOpacity
          style={{
            ...
            paddingVertical: 10,
            borderRadius: 20,
            backgroundColor: activeFilter === "all" ? '#047857' : 'rgba(20,40,32,0.65)',
        ...
        <TouchableOpacity
          style={{
            ...
            paddingVertical: 10,
            borderRadius: 20,
            backgroundColor: activeFilter === "deposits" ? '#047857' : 'rgba(20,40,32,0.65)',
            minHeight: 44,
            justifyContent: 'center',
            alignItems: 'center',
            marginLeft: 10
        ...
        <TouchableOpacity
          style={{
            ...
            paddingVertical: 10,
            borderRadius: 20,
            backgroundColor: activeFilter === "withdrawals" ? '#047857' : 'rgba(20,40,32,0.65)',
            minHeight: 44,
            justifyContent: 'center',
            alignItems: 'center',
            marginLeft: 10
        ...
        <TouchableOpacity
          style={{
            ...
            paddingVertical: 10,
            borderRadius: 20,
            backgroundColor: activeFilter === "bounties" ? '#047857' : 'rgba(20,40,32,0.65)',
            minHeight: 44,
            justifyContent: 'center',
            alignItems: 'center',
            marginLeft: 10
...
const styles = StyleSheet.create({
  ...
  transactionCard: {
    backgroundColor: 'rgba(20,40,32,0.65)',
    borderRadius: 14,
    padding: 16,
    marginBottom: 12,
    minHeight: 80,
