...
-- Date: 2025-10-10
-- Timestamped version of the previously undated risk_management_system.sql so that
-- Supabase branch migrations apply it in the correct order (after messaging schema,
-- before the numbered migrations starting 20251022).
