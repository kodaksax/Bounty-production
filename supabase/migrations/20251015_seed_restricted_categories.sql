...
-- Date: 2025-10-15
-- Timestamped version of the previously undated seed_restricted_categories.sql so that
-- Supabase branch migrations apply it in the correct order (after risk management tables
-- are created, before numbered migrations starting 20251022).
